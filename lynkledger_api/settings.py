...
# Django requiere que los orígenes de CSRF no tengan barra al final y empiecen con http(s)://
CSRF_TRUSTED_ORIGINS = [origin.rstrip('/') for origin in CSRF_TRUSTED_ORIGINS if origin]
